# Надёжный драйвер шины I2C (I2C1) для CH32V003 (RISC-V) — Версия 5.4.2 (Аудит I2C)
...
В версии 5.4.2 устранены малейшие уязвимости и потенциальные проблемы долгосрочной стабильности:
...
#### Преимущество Версии 5.4.2 для ЦАП:
